...
def main():
    ...
    # np.save('../result/CustomMLP/test_loss.npy',test_accuracy_history)
    ...
    # np.save('../result/LeNet/test_loss.npy',test_accuracy_history)
    ...
    np.save('../result/CustomLeNet/test_loss.npy',test_accuracy_history)
